...
{
    public partial class atletaspasschange : System.Web.UI.Page
    {
        ...
        protected void tb_changePass_Click(object sender, EventArgs e)
        {
            ...
            myCommand.Parameters.AddWithValue("@nome_atleta", Session["atleta"]);
            myCommand.Parameters.AddWithValue("@pw_atual", EncryptString(tb_actualPass.Text));
            myCommand.Parameters.AddWithValue("@pw_nova", EncryptString(tb_newPass.Text));

            SqlParameter validarUser = new SqlParameter();
            validarUser.ParameterName = "@retorno_pass";
            ...
            myCommand.CommandText = "alterarPWatleta";
            ...
            int replyStoredProcedure = Convert.ToInt32(myCommand.Parameters["@retorno_pass"].Value);
            ...
            if (replyStoredProcedure == 1)
            {
                ...
                lbl_msg.Text = "As passwords não coincidem!";
        }
