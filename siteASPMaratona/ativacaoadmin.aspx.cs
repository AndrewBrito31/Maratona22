...
{
    public partial class ativacaoadmin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string userAdmin = DecryptString(Request.QueryString["utilizador"]);
            ...
            myCommand.Parameters.AddWithValue("@utilizador", userAdmin);

            myCommand.CommandType = CommandType.StoredProcedure;

            myCommand.CommandText = "ativacao_userAdmin";
